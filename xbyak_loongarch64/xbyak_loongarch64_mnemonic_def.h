...
void fldx_s(const VReg &fd, const VReg &rj, const VReg &rk);     // 00111000001100000     rk      rj   fd
void fldx_d(const VReg &fd, const VReg &rj, const VReg &rk);     // 00111000001101000     rk      rj   fd
void fstx_s(const VReg &fd, const VReg &rj, const VReg &rk);     // 00111000001110000     rk      rj   fd
void fstx_d(const VReg &fd, const VReg &rj, const VReg &rk);     // 00111000001111000     rk      rj   fd
...
void fldgt_s(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101000     rk      rj   fd
void fldgt_d(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101001     rk      rj   fd
void fldle_s(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101010     rk      rj   fd
void fldle_d(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101011     rk      rj   fd
void fstgt_s(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101100     rk      rj   fd
void fstgt_d(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101101     rk      rj   fd
void fstle_s(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101110     rk      rj   fd
void fstle_d(const VReg &fd, const VReg &rj, const VReg &rk); // 00111000011101111     rk      rj   fd
